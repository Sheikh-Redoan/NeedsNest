...
export default function Menu(): React.ReactElement {
    ...
    return (
        <div className="relative"> {/* Use 'relative' for positioning the dropdown */}
            <Container>
                <ul className="flex gap-10 text-center text-lg font-normal justify-start text-stone-950 font-Poppins leading-7">
                    {/* Categories item with onClick event */}
                    <li className="relative"> {/* Use 'relative' for positioning the dropdown */}
                        <p
